...
public class SymmetryActivity extends AppCompatActivity implements VerifyFingerprintCallback {
    @BindView(R.id.btn_begin)
    Button btnBegin;
    @BindView(R.id.tv_result)
    TextView tvResult;

    private SoftReference<SymmetryActivity> softCtx;
    ...
    public void hardwareUnsupported() {
        //DO NOTHING
        //如果硬件不支持的话在上一层就不会显示该页面的入口，因此这里不需要处理
    }
