package com.allen.fingerprintdemo.togglebutton;
...
import com.allen.fingerprintdemo.R;
...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
//    private int onColor = Color.parseColor("#4ebb7f");    绿色
//    private int onColor = Color.parseColor("#c89f62");    暗黄色
    private int onColor = Color.parseColor("#F23030");     //红色
    /**
     * 关闭颜色
     */
     ...
     * 灰色带颜色
     */
    private int offColor = Color.parseColor("#EAEAEA");
    /**
     * 手柄颜色
     */
